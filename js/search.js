...
(function () {
  ...
  const staticIndex = [
    ...
    { title: 'Seguridad operativa (OpSec)', url: '/nivel-3/seguridad-operativa.html', tags: ['nivel 3', 'opsec', 'seguridad', 'phishing', 'sim swap'], section: 'Nivel 3', nivel: 3 },
    { title: 'Fiscalidad de Bitcoin', url: '/nivel-3/fiscalidad-bitcoin.html', tags: ['nivel 3', 'fiscalidad', 'impuestos', 'irpf', 'fifo'], section: 'Nivel 3', nivel: 3 },
    ...
    { title: 'LSP, liquidez y canales JIT: cómo funciona la infraestructura Lightning', url: '/lightning/lsp-y-liquidez.html', tags: ['lightning', 'lsp', 'liquidez', 'jit', 'canales'], section: 'Lightning' },
    { title: 'Submarine swaps y chain swaps: entre Lightning y on-chain', url: '/lightning/submarine-swaps.html', tags: ['lightning', 'submarine swaps', 'loop in', 'loop out', 'on-chain'], section: 'Lightning' },
    { title: 'Splicing y channel factories: el futuro de la gestión de canales', url: '/lightning/splicing-y-channel-factories.html', tags: ['lightning', 'splicing', 'channel factories', 'canales'], section: 'Lightning' },
    { title: 'Watchtowers: vigilantes de tus canales Lightning', url: '/lightning/watchtowers.html', tags: ['lightning', 'watchtower', 'seguridad', 'canales'], section: 'Lightning' },
    { title: 'PTLCs y la evolución técnica de Lightning', url: '/lightning/ptlcs-y-futuro.html', tags: ['lightning', 'ptlc', 'taproot channels', 'trampoline'], section: 'Lightning' },
    { title: 'L402: pagos nativos en la web y APIs monetizadas', url: '/lightning/l402.html', tags: ['lightning', 'l402', 'http 402', 'macaroons', 'apis'], section: 'Lightning' },
    { title: 'Agentes de IA y Lightning: la economía autónoma', url: '/lightning/agentes-ia-y-lightning.html', tags: ['lightning', 'ia', 'agentes', 'mcp', 'l402'], section: 'Lightning' },
    { title: 'Podcasting 2.0 y Value4Value: streaming de sats', url: '/lightning/podcasting-value4value.html', tags: ['lightning', 'podcasting', 'value4value', 'keysend'], section: 'Lightning' },
    { title: 'Nostr, Zaps y Lightning: pagos como capa social', url: '/lightning/nostr-zaps-y-lightning.html', tags: ['lightning', 'nostr', 'zaps', 'nip57'], section: 'Lightning' },
    { title: 'Gaming, streaming y comercio: Lightning en aplicaciones reales', url: '/lightning/gaming-streaming-comercio.html', tags: ['lightning', 'gaming', 'comercio', 'streaming'], section: 'Lightning' },
    { title: 'Micropagos web y paywalls: monetización nativa con Lightning', url: '/lightning/micropagos-web.html', tags: ['lightning', 'micropagos', 'paywall', 'webln'], section: 'Lightning' },
    { title: 'Taproot Assets: tokens y stablecoins sobre Lightning', url: '/lightning/taproot-assets.html', tags: ['lightning', 'taproot assets', 'stablecoins', 'usdt'], section: 'Lightning' },
    { title: 'eCash sobre Lightning: Cashu, Fedimint y privacidad radical', url: '/lightning/ecash-cashu-fedimint.html', tags: ['lightning', 'ecash', 'cashu', 'fedimint', 'privacidad'], section: 'Lightning' },
    { title: 'Ark: la nueva propuesta para escalar Lightning', url: '/lightning/ark.html', tags: ['lightning', 'ark', 'vtxo', 'asp'], section: 'Lightning' },
    { title: 'Cuando Lightning mueve más que sats', url: '/lightning/mas-que-sats.html', tags: ['lightning', 'extensiones', 'activos', 'ia'], section: 'Lightning' },
    { title: 'Riesgos reales y privacidad en Lightning', url: '/lightning/seguridad-y-riesgos.html', tags: ['lightning', 'riesgos', 'privacidad', 'jamming'], section: 'Lightning' },
    { title: 'Custodia en Lightning: el espectro completo', url: '/lightning/custodia-vs-autocustodia.html', tags: ['lightning', 'custodia', 'autocustodia', 'lsp'], section: 'Lightning' },
    { title: 'Errores comunes y scams en Lightning', url: '/lightning/errores-comunes.html', tags: ['lightning', 'errores', 'scams', 'estafas'], section: 'Lightning' },
