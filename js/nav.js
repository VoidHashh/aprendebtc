  ...
  const LEVEL_TREE = [
    {
      ...
      pages: [
        ...
        { href: '/nivel-1/que-has-hecho.html', text: '¿Qué acabas de hacer?' },
      ]
    },
    {
      id: 'nivel-2',
    ...
    },
    {
      ...
      pages: [
        ...
        { href: '/nivel-4/nodo-lightning.html', text: 'Tu nodo Lightning' },
        ...
        { href: '/nivel-4/calefaccion-bitcoin.html', text: 'Calefacción con Bitcoin' },
    ...
    },
    {
      ...
      pages: [
        ...
        { href: '/nivel-5/curva-eliptica.html', text: 'Curva elíptica secp256k1' },
        { href: '/nivel-5/ecdsa.html', text: 'ECDSA en detalle' },
        { href: '/nivel-5/schnorr.html', text: 'Schnorr' },
        { href: '/nivel-5/estructura-transaccion.html', text: 'Estructura de una transacción' },
        ...
        { href: '/nivel-5/protocolo-p2p.html', text: 'Protocolo P2P y gossip' },
      ]
    },
    {
      id: 'nivel-6',
      ...
      href: '/nivel-6/',
      pages: [
        { href: '/nivel-6/por-que-bitcoin-importa.html', text: 'Por qué Bitcoin importa de verdad' },
        ...
        { href: '/nivel-6/criticas-a-bitcoin.html', text: 'Las críticas a Bitcoin y respuestas' },
        ...
        { href: '/nivel-6/como-explicar-bitcoin.html', text: 'Cómo explicar Bitcoin' },
    ...
    },
    {
      ...
      pages: [
        ...
        { href: '/base/austrian-economics.html', text: 'Economía austríaca' },
    ...
    },
    {
      ...
      pages: [
        ...
        { href: '/la-madriguera/el-hackeo-de-mt-gox.html', text: 'Mt. Gox (2014)' },
        { href: '/la-madriguera/la-guerra-del-tamano-de-bloque.html', text: 'Guerra del tamaño de bloque (2015-17)' },
        { href: '/la-madriguera/la-crisis-de-terra-luna.html', text: 'Crisis Terra/Luna (2022)' },
        { href: '/la-madriguera/el-colapso-de-ftx.html', text: 'Colapso de FTX (2022)' },
        { href: '/la-madriguera/ordinals-inscriptions-debate.html', text: 'Ordinals e Inscriptions (2023)' },
        { href: '/la-madriguera/el-caso-samourai-wallet.html', text: 'Caso Samourai Wallet (2024)' },
        { href: '/la-madriguera/los-etfs-de-bitcoin.html', text: 'ETFs de Bitcoin (2024)' },

        { sectionTitle: 'FUNDAMENTOS', accent: true },
        { href: '/la-madriguera/el-ataque-del-51-por-ciento.html', text: 'El ataque del 51%' },
        { href: '/la-madriguera/bloques-huerfanos-y-reorganizaciones.html', text: 'Bloques huérfanos y reorgs' },
        ...
        { href: '/la-madriguera/la-politica-monetaria-de-bitcoin.html', text: 'La política monetaria de Bitcoin' },
        { href: '/la-madriguera/soft-forks-de-bitcoin.html', text: 'Los soft forks de Bitcoin' },
        { href: '/la-madriguera/multisig-custodia-y-herencia-segun-satoshi.html', text: 'Multisig y herencia según Satoshi' },
        ...
        { href: '/la-madriguera/la-geopolitica-de-la-mineria.html', text: 'Geopolítica de la minería' },
        ...
        { href: '/la-madriguera/bitcoin-medio-de-pago-vs-reserva-de-valor.html', text: '¿Medio de pago o reserva de valor?' },
        { href: '/la-madriguera/hiperinflaciones-y-bitcoin.html', text: 'Hiperinflaciones y Bitcoin' },
        { href: '/la-madriguera/halving-y-ciclos-de-precio.html', text: 'El halving y los ciclos de precio' },
      ]
    },
    {
      id: 'herramientas',
