...
(function () {
  ...
  const PILLAR_TREE = [
    ...
    },
    {
      ...
      index: '/la-madriguera/',
      pages: [
        { href: '/la-madriguera/los-primeros-dias-de-bitcoin.html', text: '01 - Los primeros d?as de Bitcoin' },
        { href: '/la-madriguera/bitcoin-y-wikileaks.html', text: '02 - Bitcoin y WikiLeaks' },
        { href: '/la-madriguera/silk-road-y-ross-ulbricht.html', text: '03 - Silk Road y Ross Ulbricht' },
        { href: '/la-madriguera/el-hackeo-de-mt-gox.html', text: '04 - Mt. Gox' },
        { href: '/la-madriguera/la-guerra-del-tamano-de-bloque.html', text: '05 - Guerra del tama?o de bloque' },
        { href: '/la-madriguera/la-crisis-de-terra-luna.html', text: '06 - Crisis Terra/Luna' },
        { href: '/la-madriguera/el-colapso-de-ftx.html', text: '07 - Colapso de FTX' },
        { href: '/la-madriguera/ordinals-inscriptions-debate.html', text: '08 - Ordinals e Inscriptions' },
        { href: '/la-madriguera/el-caso-samourai-wallet.html', text: '09 - Caso Samourai Wallet' },
        { href: '/la-madriguera/los-etfs-de-bitcoin.html', text: '10 - ETFs de Bitcoin' },
        { href: '/la-madriguera/el-ataque-del-51-por-ciento.html', text: '11 - El ataque del 51%' },
        { href: '/la-madriguera/bloques-huerfanos-y-reorganizaciones.html', text: '12 - Bloques hu?rfanos y reorgs' },
        ...
        { href: '/la-madriguera/la-politica-monetaria-de-bitcoin.html', text: '15 - La pol?tica monetaria de Bitcoin' },
        { href: '/la-madriguera/soft-forks-de-bitcoin.html', text: '16 - Los soft forks de Bitcoin' },
        { href: '/la-madriguera/multisig-custodia-y-herencia-segun-satoshi.html', text: '17 - Multisig y herencia seg?n Satoshi' },
        { href: '/la-madriguera/economia-austriaca-para-bitcoiners.html', text: '18 - Econom?a austr?aca para bitcoiners' },
        { href: '/la-madriguera/bitcoin-y-energia.html', text: '19 - Bitcoin y energ?a' },
        { href: '/la-madriguera/la-geopolitica-de-la-mineria.html', text: '20 - Geopol?tica de la miner?a' },
        { href: '/la-madriguera/lightning-network-estado-actual.html', text: '21 - Lightning Network: estado actual' },
        { href: '/la-madriguera/privacidad-en-bitcoin-estado-actual.html', text: '22 - Privacidad en Bitcoin: estado actual' },
        { href: '/la-madriguera/puede-un-gobierno-prohibir-bitcoin.html', text: '23 - ?Puede un gobierno prohibir Bitcoin?' },
        { href: '/la-madriguera/el-debate-de-la-osificacion.html', text: '24 - El debate de la osificaci?n' },
